  ...
  <div class="recommend">
    ...
    <div class="all-movie">
      ...
      <transition-group name="fade">
        <div class="movie" v-for="movie in seasonMovies" :key="movie.id">
          <img
...
export default {
  ...
  computed: {
    seasonMovies() {
      return this.$store.state.seasonMovies.slice(this.num, this.num + 5);
    },
    seasonGenre() {
      return this.$store.state.seasonGenre;
    },
  },
  data() {
    return {
